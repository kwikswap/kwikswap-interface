...
export default function Header() {
  ...
  return (
    <HeaderFrame>
      {/* <ClaimModal /> */}
      <Modal isOpen={showKwikBalanceModal} onDismiss={() => setShowKwikBalanceModal(false)}>
        <KwikBalanceContent setShowKwikBalanceModal={setShowKwikBalanceModal} />
      </Modal>
      <HeaderRow>
        <Title href=".">
          <KwikIcon>
        ...
        <HeaderLinks>
          ...
          {/* <StyledNavLink id={`stake-nav-link`} to={'/Kwik'}>
            KWIK
          </StyledNavLink> */}
          <StyledNavLink id={`stake-nav-link`} to={'/votepage'}>
            Vote
          </StyledNavLink>
          <StyledExternalLink id={`stake-nav-link`} href={'https://info.kwikswap.org'}>
