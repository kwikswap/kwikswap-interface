...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@kwikswap/sdk'
...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0x404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe('0x404A895237C97B75d4Cf96C8Ad9760687692613A')
      expect(isAddress('0x404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe('0x404A895237C97B75d4Cf96C8Ad9760687692613A')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe('0x404A895237C97B75d4Cf96C8Ad9760687692613A')
    })
    it('fails if too long', () => {
      expect(isAddress('404A895237C97B75d4Cf96C8Ad9760687692613A0')).toBe(false)
    })
  })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0x404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe('0x404A...613A')
    })

    it('truncates middle characters even without prefix', () => {
      expect(shortenAddress('404A895237C97B75d4Cf96C8Ad9760687692613A')).toBe('0x404A...613A')
    })
