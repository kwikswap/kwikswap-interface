...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    KWIKBACKGROUND: darkMode ? 'rgb(16, 226, 242)' : 'rgb(16, 226, 242)',
    ...
    RDial: darkMode ? '#020202' : '#363cff4a',
    ...
    settingMenuiconStrokeColor: darkMode ? '#4D8FEA' : '#4D8FEA',
    voteCardColor: darkMode
      ? 'radial-gradient(76.02% 75.41% at 1.84% 0%,#2f60b7 0%,#151515 100%)'
      : 'radial-gradient(76.02% 75.41% at 1.84% 0%,#2f60b7 0%,#6fc6ff 100%)',
    //specialty colors
