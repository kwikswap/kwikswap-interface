...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@kwikswap/sdk'
      ...
      callback: async function onSwap(): Promise<string> {
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'KwikswapV1Router: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'KwikswapV1Router: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
        ...
        return contract[methodName](...args, {
          ...
          .then((response: any) => {
            ...
            const withVersion =
              tradeVersion === Version.v1 ? withRecipient : `${withRecipient} on ${(tradeVersion as any).toUpperCase()}`
