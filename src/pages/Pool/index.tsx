          ...
          <CardSection>
            <AutoColumn gap="md">
              ...
              <ExternalLink
                ...
                target="_blank"
                href="https://kwikswap.org/docs/v1/core-concepts/pools/"
              >
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            ...
            {!account ? (
              ...
              <>
                <ButtonSecondary>
                  <RowBetween>
                    <ExternalLink href={'https://info.kwikswap.org/account/' + account}>
            ...
            <AutoColumn justify={'center'} gap="md">
              <Text textAlign="center" fontSize={14} style={{ padding: '.5rem 0 .5rem 0' }}>
                {hasVLiquidity ? 'Kwikswap V liquidity found!' : "Don't see a pool you joined?"}{' '}
