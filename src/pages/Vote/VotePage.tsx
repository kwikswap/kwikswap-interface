...
import { CardSection, DataCard } from '../../components/vote/styled'
...
import { TokenAmount, JSBI } from '@kwikswap/sdk'
import { useActiveWeb3React } from '../../hooks'
import { PROPOSAL_LENGTH_IN_SECS, COMMON_CONTRACT_NAMES, KWIK, ZERO_ADDRESS } from '../../constants'
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          {proposalData && proposalData.status === 'active' && !showVotingButtons && (
            <GreyCard>
              <TYPE.black>
                Only KWIK votes that were self delegated or delegated to another address before block{' '}
